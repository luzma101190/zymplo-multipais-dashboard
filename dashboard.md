...
>
> **Última actualización:** 2026-05-19 · **🇦🇷 AR OF smoke E2E verde · Oracle persistencia confirmada LINK_ID=95** post-#871/#872 (deploy script CL-leftover + smoke paths) + DevOps rebuilt Prometeo core con key rotada + workflow label fix (#876) · **🇺🇾🇪🇨🇵🇪 UY/EC/PE OF Oracle pool connected** post-#877/#878 (mismo CL-drift en 3 thins + PE port collision 3106→3109) · **🇺🇸 USA OF smoke E2E 11/11 verde** post-#865/#866/#869 (seed Akoya + LINK_STATUS bridge + LINK_EMPRESA_ID overflow fix) · **Encadenado OF multipaís cerrado**: PE #861 + UY #862 + mobile screens BO/CL/CO/EC #863 mergeados · OF integration pattern (proxy + mobile hook + bot dispatcher) ahora completo en 11 países (MX/BO/CL/BR/EC/AR/CO/UY/PE/USA + ES sin OF) · **Pendiente DevOps**: activar `OPENFINANCE_{CL,CO,UY,PE}_ENABLED=true` + tokens en runtime · **🇪🇸 ES facturación E2E Oracle real 2026-05-19** (provider mock · cert AEAT pendiente Jesús · Invoice #21 €2.023 · **Facturae XML 3.2.2 oficial** + QR Verifactu RD 1007/2023 + PDF 101KB con contenido legal obligatorio · AEAT no define layout PDF oficial) · **🚨 PE facturación NO finalizado · no alineado a Oracle (sólo SQLite)** · 6 países con E2E con persistencia Oracle real · CO [PDF](samples/colombia/factura-1-co-SETP5.pdf) · EC [PDF](samples/ecuador/factura-1-ec-001-001-000000001.pdf) · CL [PDF](samples/chile/dte-33-cl-folio-1.pdf) · UY [PDF Oracle real](samples/uruguay/cfe-21-uy-real-oracle.pdf) · USA [PDF Oracle real](samples/usa/invoice-000001-acme-corp.pdf) · **ES** [PDF Oracle real](samples/espana/factura-21-es-E2E-2.pdf) · PE [preview SQLite](samples/peru/factura-01-pe-F001-00000001.pdf)
...
| 🇵🇪 **Perú** | ❌ **NO alineado a Oracle ZMP** · E2E NO finalizado · usa SQLite · PR #867 (Martin) pending rebase | ✅ Belvo PE · thin Oracle **connected 2026-05-19** (post-#878 deploy script CL-drift + port 3106→3109 collision con EC) · OF proxy + mobile hook + bot dispatcher (#861) | ✅ App · ✅ WA (#764 bot + #767 v2 proxy + #768 mobile + #763 PDF+público-view + #861 OF integration) | [openfinance-pe-qa](https://openfinance-pe-qa.zymplo.com/api-docs/) |
...
| 🇪🇸 **España** | ✅ **E2E QA público live 2026-05-19** (provider mock · cert AEAT pendiente Jesús) | 🟡 **Tink (PSD2 EU) · código listo PR #887** · servicio standalone zymplo-openfinance-es · mock+tink connector factory · reconciliation engine 0-100 portado del legacy · pendiente DevOps deploy + Tink Console creds | ✅ App · ✅ WA (PR #843 mobile hook + #849 bot tools + workflow + mount proxy) | [facturacion-es-qa](https://facturacion-es-qa.zymplo.com/api-docs/) |
