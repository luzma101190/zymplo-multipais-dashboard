...
| 🇨🇷 **Costa Rica** | 🟡 Hacienda CR en monorepo (#893 port Martin + #899 PDF Hacienda-compliant) · 10 tablas `CR_FE_*` aplicadas en ZMP · PDF cumple RES-DGT-033-2019 (CABYS + tarifa IVA + condición venta + medio pago + total en letras CRC) · [sample Hacienda](samples/costarica/factura-01-cr-hacienda-oficial.pdf) · falta DevOps build+deploy del service | ✅ OF QA healthy | 🟡 App + WA (PR #893 mobile hook `useHaciendaCr.ts` + hex proxy `hacienda-cr`) | [openbanking-cr-qa](https://openbanking-cr-qa.zymplo.com/api-docs/) |
...
| 🇪🇸 **España** | ✅ **E2E QA público live 2026-05-19** (provider mock · cert AEAT pendiente Jesús) | ✅ **E2E Oracle real + QA público DEPLOYADO 2026-05-19** (provider mock · Tink Console creds pendiente) · reconciliation engine cierra inv 25 EMITTED→PAID (score 100) · 3 ZMP_OF_LINK + 1 ZMP_OF_ACCOUNT + 1 ZMP_OF_TRANSACTION country=ESP | ✅ App · ✅ WA (PR #843 mobile hook + #849 bot tools + workflow + mount proxy) | [facturacion-es-qa](https://facturacion-es-qa.zymplo.com/api-docs/) · [openfinance-es-qa](https://openfinance-es-qa.zymplo.com/api-docs/) |
