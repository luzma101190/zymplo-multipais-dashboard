...
| 🇵🇪 **Perú** | ✅ **E2E sandbox · Oracle real 2026-05-19** post-#867 (port Martin a Oracle ZMP) + 11 tablas `PE_FE_*` aplicadas · CPE_ID=21 F001-1 · 4130 PEN · IGV 18% · PDF SUNAT (Puppeteer + Nunjucks + QR RS 193-2020) + UBL 2.1 firmado XMLDSig descargables vía API | ✅ Belvo PE · thin Oracle **connected 2026-05-19** (post-#878 deploy script CL-drift + port 3106→3109 collision con EC) · OF proxy + mobile hook + bot dispatcher (#861) | ✅ App · ✅ WA (#764 bot + #767 v2 proxy + #768 mobile + #763 PDF+público-view + #861 OF integration) | [facturacion-pe-qa](https://facturacion-pe-qa.zymplo.com/docs/) · [openfinance-pe-qa](https://openfinance-pe-qa.zymplo.com/api-docs/) · [PDF SUNAT real](samples/peru/factura-21-pe-F001-1-real.pdf) · [UBL XML](samples/peru/factura-21-pe-F001-1-real.xml) |
