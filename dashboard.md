...
| 🇪🇸 **España** | ✅ **E2E QA público live 2026-05-19** (provider mock · cert AEAT pendiente Jesús) | ❌ no aplica (no aggregator EU integrado) | ✅ App · ✅ WA (PR #843 mobile hook + #849 bot tools + workflow + mount proxy) | [facturacion-es-qa](https://facturacion-es-qa.zymplo.com/api-docs/) |
